...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "mikeyaz-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/capcto"
  #   chef.validation_client_name = "capcto-validator"
  #   chef.validation_key_path = ".chef/capcto-validator.pem"
  # end
end
